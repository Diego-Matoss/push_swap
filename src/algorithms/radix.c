...
// Averigua cuántos bits tiene el número más grande para saber cuántas pasadas dar
...
void radix_sort(t_stack *a, t_stack *b)
{
    ...
    while (i < max_bits)
    {
        ...
        while (j < size)
        {
            // MAGIA DE BITS: Desplazamos el número 'i' posiciones y miramos si termina en 1 o en 0
        ...
        i++; // Pasamos a la siguiente ronda (al siguiente bit más a la izquierda)
    }
}
